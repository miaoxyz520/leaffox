...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $msg = '主页设置已保存 ' + '<i class="fas fa-check-circle" style="color:#10b981"></i>';
    ...
    <div class="grid grid-cols-2 gap-4">
      <div><label class="block text-gray-300 text-xs font-medium mb-1.5">主题模式</label>
        <select name="theme_mode" class="w-full md:w-auto" style="max-width:100%">
          <option value="auto" <?=$user['theme_mode']=='auto'?'selected':''?>><i class="fas fa-circle-half-stroke"></i> 跟随系统</option>
          <option value="light" <?=$user['theme_mode']=='light'?'selected':''?>><i class="fas fa-sun"></i> 浅色</option>
          <option value="dark" <?=$user['theme_mode']=='dark'?'selected':''?>><i class="fas fa-moon"></i> 深色</option>
        </select>
      </div>
      <div><label class="block text-gray-300 text-xs font-medium mb-1.5">卡片风格</label>
        <select name="card_style" class="w-full md:w-auto" style="max-width:100%">
          <option value="glass" <?=$user['card_style']=='glass'?'selected':''?>><i class="fas fa-window-restore"></i> 玻璃质感</option>
          <option value="neumorphism" <?=$user['card_style']=='neumorphism'?'selected':''?>><i class="fas fa-border-all"></i> 新拟态</option>
          <option value="minimal" <?=$user['card_style']=='minimal'?'selected':''?>><i class="fas fa-square"></i> 极简</option>
        </select>
      </div>
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div><label class="block text-gray-300 text-xs font-medium mb-1.5">页脚对齐</label>
        <select name="footer_align">
          ...
          <option value="right" <?=$user['footer_align']==='right'?'selected':''?>> <i class="fas fa-arrow-right"></i> 右对齐</option>
        </select>
      </div>
    </div>
