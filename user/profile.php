...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
  <!-- 左侧：个性后缀（突出显示） -->
  <div class="card-base">
    <h3><i class="fas fa-link text-indigo-400"></i> 我的主页</h3>
    <div class="text-center">
      <div class="w-28 h-28 mx-auto rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white text-3xl font-bold overflow-hidden mb-3 shadow-lg shadow-emerald-500/20">
      ...
      <form method="POST">
        ...
        <button type="submit" class="btn-sm btn-primary w-full"><i class="fas fa-save"></i> 保存后缀</button>
      </form>
    </div>
  </div>
