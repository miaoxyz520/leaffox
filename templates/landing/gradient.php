<?php
/**
 * Leaffox 系统首页模版 - Gradient（内置）
 * ============================================
 * 模版类型：landing（系统落地页）
 * 文件路径：templates/landing/gradient.php
 * 风格：大色块渐变背景，视觉冲击力强，年轻动感
...
body{
  ...
  color:#fff;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"PingFang SC","Microsoft YaHei",sans-serif;
  min-height:100vh;overflow-x:hidden;
}
@keyframes gradientBG{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}
.wrap{position:relative;z-index:1;max-width:960px;margin:0 auto;padding:0 24px}
.overlay{position:fixed;inset:0;background:rgba(0,0,0,0.15);z-index:0}

.navbar{display:flex;align-items:center;justify-content:space-between;padding:20px 0;border-bottom:1px solid rgba(255,255,255,0.15)}
.nav-logo{display:flex;align-items:center;gap:10px;font-size:20px;font-weight:800;color:#fff;text-decoration:none;text-shadow:0 2px 8px rgba(0,0,0,0.15)}
.nav-logo .logo-icon{width:34px;height:34px;border-radius:8px;background:rgba(255,255,255,0.2);backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;font-size:16px;font-weight:900;color:#fff}
...
.nav-btn-outline{border:1px solid rgba(255,255,255,0.3);color:#fff;background:transparent;backdrop-filter:blur(4px)}
.nav-btn-outline:hover{border-color:rgba(255,255,255,0.6);background:rgba(255,255,255,0.1)}
.nav-btn-solid{background:rgba(255,255,255,0.2);color:#fff;border:none;backdrop-filter:blur(8px)}
...
.hero-btn-secondary:hover{background:rgba(255,255,255,0.2);border-color:rgba(255,255,255,0.35)}

.section-title{text-align:center;margin-bottom:48px}
.section-title h2{font-size:30px;font-weight:800;text-shadow:0 2px 12px rgba(0,0,0,0.1)}
.section-title p{color:rgba(255,255,255,0.7);font-size:15px}
...
.steps{padding:60px 0;border-top:1px solid rgba(255,255,255,0.12)}
.step-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:20px}
.step-card{text-align:center;padding:24px 16px}
.step-num{width:44px;height:44px;border-radius:50%;background:#ffd700;color:#667eea;display:flex;align-items:center;justify-content:center;margin:0 auto 14px;font-size:18px;font-weight:800}
...
.footer{border-top:1px solid rgba(255,255,255,0.1);padding:24px 0;text-align:center;font-size:13px;color:rgba(255,255,255,0.5)}
...
<div class="wrap">
  ...
  <section class="hero">
    <div class="hero-badge"><i class="fas fa-rainbow"></i> <?=h($siteName)?></div>
    <h1>你的色彩，<span class="highlight">你的主页</span></h1>
    <p><?=h($siteDesc)?></p>
